...
Total Funded Amount: Total loan amount disbursed, including MTD performance and MoM growth analysis.
Total Amount Received: Total repayments collected from borrowers, helping assess cash flow and repayment behavior.
Average Interest Rate: Analysis of average interest rates across all loans with MTD and MoM trends.
Average Debt-to-Income (DTI) Ratio: Measurement of borrower financial health and repayment capacity.

Visualization:
Loan Status Summary Grid:
A consolidated view of loan performance categorized by Loan Status, displaying metrics such as application 
...
Loan Term Distribution (Donut Chart): Visualizes loans across different repayment durations.
Employment Length Analysis (Bar Chart): Examines lending behavior based on borrower employment experience.
Loan Purpose Analysis (Bar Chart): Breaks down loans by stated purpose to identify dominant borrowing needs.
...
Assists financial institutions in optimizing lending strategies and mitigating default risks.

Conclusion

The Bank Loan Analysis Power BI project delivers a structured and interactive approach to analyzing loan data. 
By combining KPIs, trend analysis, and detailed loan-level insights, the dashboards empower stakeholders to make informed decisions, 
improve operational efficiency, and enhance overall lending performance.
